          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            >
              <div className="flex justify-center mb-6">
                <div className="p-6 rounded-full" style={{ backgroundColor: '#C8E6C9' }}>
                  <Phone className="text-green-700" size={40} />
                </div>
              </div>
              <h3 className="text-center text-green-800 mb-4" style={{ fontSize: '1.5rem' }}>
                {t.contactNumbers}
              </h3>
              <div className="space-y-3 text-center">
                <div>
                  <p className="text-gray-600 mb-1">{t.cell}</p>
                  <a href="tel:9440171005" className="text-green-700 hover:text-green-900" style={{ fontSize: '1.2rem' }}>
                    9440171005
                  </a>
                  <br />
                  <a href="tel:8885273955" className="text-green-700 hover:text-green-900" style={{ fontSize: '1.2rem' }}>
                    8885273955
                  </a>
                </div>
                <div className="pt-3 border-t border-gray-200">
                  <p className="text-gray-600 mb-1">{t.office}</p>
                  <a href="tel:08646274055" className="text-green-700 hover:text-green-900" style={{ fontSize: '1.2rem' }}>
                    08646 - 274055
                  </a>
                </div>
              </div>
            ...
            >
              <div className="flex justify-center mb-6">
                <div className="p-6 rounded-full" style={{ backgroundColor: '#A5D6A7' }}>
              ...
              <div className="text-center">
                <p className="text-gray-700" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
            ...
            >
              <div className="flex justify-center mb-6">
                <div className="p-6 rounded-full" style={{ backgroundColor: '#81C784' }}>
              ...
              <div className="text-center">
                <p className="text-gray-900" style={{ fontSize: '1.3rem', marginBottom: '0.5rem' }}>
                  {t.proprietorName}
                </p>
          ...
          <div className="mb-16">
            ...
            >
              <div className="flex justify-center items-center gap-4 mb-4">
                <Warehouse className="text-green-700" size={48} />
                <h2 className="text-green-800" style={{ fontSize: '2.5rem' }}>
                  {t.godownContacts}
                </h2>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
              {godownManagers.map((manager, index) => (
                ...
                >
                  <div className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500" style={{ border: '4px solid #43A047' }}>
                    {/* Photo Section */}
                    ...
                    <div className="p-8 bg-gradient-to-br from-white to-green-50">
                      <h3 className="text-green-800 mb-3" style={{ fontSize: '1.8rem' }}>
                        {manager.name}
                      </h3>
                      ...
                      <a
                        href={`tel:${manager.phone.replace(/\s/g, '')}`}
                        className="block w-full text-center py-4 rounded-xl text-white transition-all duration-300 transform hover:scale-105 hover:shadow-lg mt-6"
                  ...
                  {/* Decorative Elements */}
                  <div className="absolute -z-10 top-4 right-4 w-full h-full rounded-3xl" style={{ backgroundColor: '#C8E6C9' }}></div>
                </motion.div>
              ))}
            </div>
          </div>
