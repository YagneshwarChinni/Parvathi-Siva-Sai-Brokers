      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="space-y-8">
            ...
            {/* Quote Section */}
            <div className="relative mt-12 py-12 px-8 rounded-3xl overflow-hidden" style={{
              ...
              <div className="relative z-10 text-center">
                <svg className="w-16 h-16 mx-auto mb-4 text-yellow-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              <div className="w-16 h-16 rounded-full mx-auto mb-6 flex items-center justify-center" style={{ backgroundColor: '#C8E6C9' }}>
                <svg className="w-8 h-8" style={{ color: '#1B5E20' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h3 className="text-center mb-6" style={{ color: '#1B5E20', fontSize: '1.8rem' }}>
